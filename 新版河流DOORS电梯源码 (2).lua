...
game.Workspace.ChildAdded:Connect(function(inst)
        if inst.Name == "RushMoving" and OrionLib.Flags["MobToggle"].Value == true and bool2 then
        ...
        elseif inst.Name == "AmbushMoving" and OrionLib.Flags["MobToggle"].Value == true and bool2 then
            if OrionLib.Flags["AvoidRushToggle"].Value == true and bool2 then
                OrionLib:MakeNotification({
                    Name = "Warning!",
